# Disabling snake casing (eg was asking me to rename dt to d_t, which is silly)
...
def main():
    ...
    stencil_points = 5  # points in the stencil for our numerical derivative in the secant method
